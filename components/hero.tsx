...
const Hero = () => {
  return (
    <div className="w-full h-[calc(100vh-100px)] mt-[100px] bg-black/[0.96] relative overflow-hidden container mx-auto">
      <Spotlight
      ...
      <div className="flex h-full flex-col md:flex-row gap-6">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-bl from-neutral-50 to-neutral-500">
            AI Coach – Votre allié intelligent pour décrocher le job de vos
            rêves !
          </h1>
          <p className="text-neutral-300 max-w-lg text-sm md:text-md">
